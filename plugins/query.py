        ...
        try:
            ...
            if AUTH_CHANNEL and isinstance(links, list) and len(links) > 0:  # User is NOT subscribed
                if clicked == typed:
                    ...
                    await query.answer(f"Hey {query.from_user.first_name}, This is not your movie request. Request your own!", show_alert=True)
            elif settings['botpm']:
                if clicked == typed:
                    await query.answer(url=f"https://t.me/{temp.U_NAME}?start={ident}_{file_id}")
                    return
                ...
                if clicked == typed:
                    ...
                    return await query.answer('Check PM, I have sent the file in PM', show_alert=False)
                else:
                    return await query.answer(f"Hey {query.from_user.first_name}, This is not your movie request. Request your own!", show_alert=True)
